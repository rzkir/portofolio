...
import { articles } from "@/components/content/articles/data/articles"
                                ...
                                <div key={idx} className='group cursor-pointer'>
                                    ...
                                    <div className='space-y-4 mt-6 py-2'>
                                        <div className='inline-block'>
                                            <span className='px-3 py-1 text-sm font-medium text-muted-foreground bg-muted rounded-full group-hover:bg-accent group-hover:text-accent-foreground transition-colors duration-300'>
                                                {item.category}
                                            </span>
                                        </div>
                                        ...
                                        <div className='flex items-center gap-2 text-sm text-muted-foreground'>
                                            ...
                                            <span className='font-medium group-hover:text-foreground transition-colors duration-300'>{item.authorName}</span>
                                            <span className='w-1 h-1 bg-primary rounded-full'></span>
                                            <span className='group-hover:text-foreground transition-colors duration-300'>{item.date}</span>
                                        </div>
